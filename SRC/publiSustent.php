                        ...
                        <div class="register-box">
                            ...
                            <div class="card">
                                <div class="card-body register-card-body">
                                    <p class="login-box-msg">Publicação Sustentabilidade</p>
...
<!--Form cadastro Sustentabilidade-->
<div class="content-wrapper">
    <section class="content-header">
        <div class="container-fluid">

            <div class="card-body register-card-body" id="publisust">


                <div class="container-fluid">
                    <form action="" method="post" enctype="multipart/form-data">

                        <h3>Publicação Sustentabilidade </h3>

                        <div class="form-group">
                            <label for="title">Título</label>
                            <input type="text" class="form-control" name="tituloPost" id="tituloPost">
                        ...
                        <div clas="form-group">
                            ...
                            <textarea class="form-control" name="descricaoPost" id="descricaoPost" cols="30" rows="10">
                                            </textarea>
                        </div>
                        <br>
